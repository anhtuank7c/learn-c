...
I will not repeat the content of 100 Days of Code, I just link all the exercises day by day in this document.
...
### Journey 02 - Days 11-20 (10 days)

Data structures & Algorithms - linked lists, stacks, queues, trees, graphs, and hash tables. Learn manual memory management with `malloc`/`free` and understand how data is organized in memory.
...
### Journey 03 - Days 21-40 (20 days)

Solve basic level problems - Practice array manipulation, string processing, basic recursion, and simple pointer operations. Build confidence and speed.
...
### Journey 04 - Days 41-60 (20 days)

Solve medium level problems - Tackle intermediate challenges involving dynamic memory allocation, multi-level pointers, struct manipulation, and algorithm optimization. Focus on time/space complexity analysis.
...
### Journey 05 - Days 61-75 (15 days)

Solve hard level problems - Conquer advanced problems requiring sophisticated algorithms, complex data structure combinations, and optimal memory usage. Prepare for competitive programming and technical interviews.
...
### Journey 06 - Days 76-85 (10 days)

System design - Learn low-level system design concepts: file I/O, process communication, socket programming basics, and memory-efficient architecture. Understand how C programs interact with the operating system.
